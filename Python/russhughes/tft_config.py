...
def config(rotation=0, buffer_size=0, options=0):
    spi = SPI(2, baudrate=40_000_000, sck=Pin(18), mosi=Pin(19), miso=None)
    width, height = 135, 240
    return st7789.ST7789(spi, width, height,
        ...
        rotation=rotation,           # 0=portrait, 1=landscape(90°), 2=reverse prtrait(180°), 3=reverse landscape(270°)
        options=options,             # 0=no wrap, 1=wrap vertically, 2=wrap horizontally, 3=wrap both
